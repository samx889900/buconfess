...
export async function POST(
  ...
  try {
    ...
    const rejected = await forceRejectConfession(id, { reason, actor: 'admin' });
    return NextResponse.json({
      success: true,
      confession: formatConfessionForAdmin(rejected),
    });
  } catch (e) {
    ...
    console.error('Error in force reject route:', e);
